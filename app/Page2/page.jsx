...
const Page = () => {
    ...
    return (
        <div className="page2 w-full bg-black relative">
            ...
            {/* Extra sections for storytelling */}
            <section
                className="relative w-full h-[500px] flex items-center justify-center bg-fixed bg-center bg-cover bg-no-repeat"
                style={{ backgroundImage: "url('/helmet/frame_0001.jpeg')" }}
            >
                {/* Overlay tint */}
            ...
            <section
                className="relative w-full h-[500px] flex items-center justify-center bg-fixed bg-center bg-cover bg-no-repeat"
                style={{ backgroundImage: "url('/helmet/frame_0002.jpeg')" }}
            >
                {/* Overlay tint */}
                <div className="absolute inset-0 bg-[rgba(0,0,0,0.4)]" />
            ...
            <section
                className="relative w-full h-[500px] flex items-center justify-center bg-fixed bg-center bg-cover bg-no-repeat"
                style={{ backgroundImage: "url('/helmet/frame_0003.jpeg')" }}
            >
                {/* Overlay tint */}
                <div className="absolute inset-0 bg-[rgba(0,0,0,0.4)]" />
